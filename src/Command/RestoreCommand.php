 ...
 *
 * Used for restoring database backups created with `Oldstyle backup` (or possibly any other type of mysql backup).
 *
...
class RestoreCommand extends BaseCommand
{
    ...
    protected function configure()
    {
        $this
            ->setName('restore')
            ->setDescription('Restores the MODX database from a database dump created by `Oldstyle backup`')
