        ...
        foreach ($this->config['data'] as $folder => $options) {
            ...
            switch (true) {
                case (!empty($options['type']) && $options['type'] == 'content'):
                    ...
                    $this->extractContent(OLDSTYLE_WORKING_DIR . $this->config['data_directory'] . $folder, $options);
                ...
                case (!empty($options['class'])):
                    ...
                    $this->extractObjects(OLDSTYLE_WORKING_DIR . $this->config['data_directory'] . $folder, $options);
