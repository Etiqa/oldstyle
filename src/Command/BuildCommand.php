...
class BuildCommand extends BaseCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption(
                ...
                null,
                InputOption::VALUE_NONE,
                'When using the --force attribute, Oldstyle will automatically create a full database backup first. Specify --no-backup to skip creating the backup, at your own risk.'
            )
    ...
    public function buildContent($folder, $type)
    {
        ...
        $folder = OLDSTYLE_WORKING_DIR . $folder;
